        ...
        <div className="bookRentModalSec">
          <div className="bookInfo">
            ...
            <div>
              ...
              <p className="subTitle space-2x">{author} • {publisher} • {datetime}</p>
            </div>
          </div>
          ...
          <div className="rentInfoSec space-3x">
            ...
            <div className="rentInfoTable">
              ...
              <span><strong>7일</strong></span>
            </div>
            <div className="rentInfoTable">
              <span className="th">반납예정일</span>
              <span><strong>{rentTime}</strong></span>
            </div>
          </div>
        </div>

        <div className="btnSec">
          {status === 'rented' && <button type="button" onClick={() => history.goBack()} className="Btn-default Btn-md">
            예약하기
          </button>}
          {status === 'available' && <button type="button" onClick={() => history.goBack()} className="Btn-default Btn-md">
            대여하기
          </button>}
          <button
            type="button"
